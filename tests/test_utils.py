...
def test_get_card_number_list(transactions: list) -> None:
    assert get_card_number_list(transactions) == ["*7197", "*4556"]


def test_get_operations_sum(transactions: list) -> None:
...
def test_get_cashback_sum(x: float, expected: float) -> None:
    assert get_cashback_sum(x) == expected


def test_show_cards(transactions: list) -> None:
...
def test_show_top_5_transactions(transactions: list) -> None:
...
@patch("requests.get")
def test_fetch_and_show_currency_rates(mock_get: Any) -> None:
